	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-blue-900 flex flex-col items-center justify-center mt-16 px-4 sm:px-6 lg:px-8">
			...
			>
				...
				>
					Upload your assignments effortlessly with our secure and user-friendly
					platform. Designed for students, built for success.
				</motion.p>
				...
				>
					...
					>
						...
						<p className="mt-2 text-white/70">
							Submit assignments in just a few clicks with our intuitive
							interface.
						</p>
					</motion.div>
					<motion.div
			...
			>
				<p>
					&copy; {new Date().getFullYear()} Assignment Upload App. All rights
					reserved.
				</p>
			</motion.footer>
		</div>
