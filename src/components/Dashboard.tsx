											...
											>
												...
												<td className="p-3">
													<button
														...
														className="text-blue-400 hover:text-blue-300 before:content-['Download'] hover:before:opacity-100 before:absolute before:opacity-0 before:bg-gray-200 before:text-black before:translate-y-full before:p-2 before:text-xs befor:duration-300 before:rounded "
													>
