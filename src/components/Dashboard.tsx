...
export default function Dashboard() {
  ...
  // Use custom hooks
  const { uploads, totalUploads, totalPages, loading: assignmentsLoading } = useAssignments(filters, page, user?.role);
  const { totalUsers, loading: usersLoading } = useUsers(user?.role);
