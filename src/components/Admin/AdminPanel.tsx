          ...
          <div className="overflow-x-auto">
            <motion.table className="w-full">
              <motion.thead className="border-b-2 border-gray-300 text-white">
                <motion.tr>
                  <motion.th className="text-start p-4 uppercase">Student Name</motion.th>
                  <motion.th className="text-start p-4 uppercase">Matric Number</motion.th>
                  <motion.th className="text-start p-4 uppercase">Course Code</motion.th>
                  <motion.th className="text-start p-4 uppercase">Level</motion.th>
                  <motion.th className="text-start p-4 uppercase">Upload Date</motion.th>
                  <motion.th className="text-start p-4 uppercase">Actions</motion.th>
                </motion.tr>
              </motion.thead>
              <motion.tbody>
                {submissions.length > 0 ? (
                  submissions.map((submission) => (
                    ...
                    >
                      <td className="p-4">{submission.student_name.toUpperCase()}</td>
                      <td className="p-4">{submission.matric_number.toUpperCase()}</td>
